...
.pp-kpis{display:grid;grid-template-columns:repeat(6,1fr);gap:8px;margin-top:14px}.pp-kpis>div{background:#0d171c;border:1px solid #29363e;border-radius:12px;padding:11px}.pp-kpis small,.pp-ex small{display:block;color:#829099;font-size:11px}.pp-kpis b{display:block;font-size:20px;margin-top:4px}
